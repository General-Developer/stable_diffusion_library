...
git init
git branch -M main
git remote add origin https://github.com/General-Developer/stable_diffusion_library
git remote set-url --push origin https://General-Developer:{main_github_token}@github.com/General-Developer/stable_diffusion_library
