...
// import 'package:stable_diffusion_library/babylon/src/bindings.dart';
// import "package:path/path.dart" as path;

// class TextToSpeechStableDiffusionLibrary {
//   final Directory directoryTemp;
//   TextToSpeechStableDiffusionLibrary({
//     required this.directoryTemp,
//   });
//   BabylonIo? _lib;

//   /// Getter for the Stable Diffusion Library.
//   ///
//   /// Loads the library based on the current platform.
//   BabylonIo get lib {
//     if (_lib == null) {
//       if (Platform.isWindows) {
//         _lib = BabylonIo(DynamicLibrary.open('tts_stable_diffusion_library.dll'));
//       } else if (Platform.isLinux || Platform.isAndroid) {
//         _lib = BabylonIo(DynamicLibrary.open('/home/galaxeus/Documents/github/general-developer/stable_diffusion_library/package/stable_diffusion_library_flutter/linux/libtts_stable_diffusion_library.so'));
//       } else if (Platform.isMacOS || Platform.isIOS) {
//         _lib = BabylonIo(DynamicLibrary.open('libtts_stable_diffusion_library.dylib'));
//       } else {
...
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/stable_diffusion_library/package/stable_diffusion_library/models/deep_phonemizer.onnx",
//       );
//     });

//     final File vitsModel = await Future(() async {
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/stable_diffusion_library/package/stable_diffusion_library/models/amy.onnx",
//       );
//     });
...
//   final TextToSpeechStableDiffusionLibrary textToSpeechStableDiffusionLibrary = TextToSpeechStableDiffusionLibrary(
//     directoryTemp: Directory(path.join(Directory.current.path, "temp")),
//   );

//   await textToSpeechStableDiffusionLibrary.init();

//   final String text = "Hello World";
//   final result = textToSpeechStableDiffusionLibrary.createSpeech(text: text);
//   print(result);
