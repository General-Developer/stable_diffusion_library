...
import 'package:stable_diffusion_app/page/stable_diffusion/stable_diffusion.dart';
...
void main() async {
await  StableDiffusionAppClientFlutter.ensureInitialized();
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GeneralLibFlutterAppMain(
      generalLibFlutterApp: StableDiffusionAppClientFlutter.generalLibFlutterApp,
...
class _MainAppState extends State<MainApp> with GeneralLibFlutterStatefulWidget {
  ...
  Future<void> initialized() async {
    ...
    await Future(() async {
      ...
      await StableDiffusionAppClientFlutter.initialized(
        context: context,
        onLoading: (text) {
