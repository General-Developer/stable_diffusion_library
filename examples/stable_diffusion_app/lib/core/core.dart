...
class StableDiffusionAppClientFlutter {
  ...
  /// General Library Documentation Undocument By General Corporation & Global Corporation & General Developer
  static ApplicationStableDiffusionLibraryDatabase coreDatabaseValue() {
    return coreDatabaseMiniLibrary.valueBuilder(
      builder: (db) {
        return ApplicationStableDiffusionLibraryDatabase(db.stateData);
      },
    );
  }
...
extension StateStableDiffusionLibraryExtensionFLutter<T extends StatefulWidget> on State<T> {
  ApplicationStableDiffusionLibraryDatabase getApplicationStableDiffusionLibraryDatabase() {
    return StableDiffusionAppClientFlutter.coreDatabaseValue();
  }

  void saveApplicationStableDiffusionLibraryDatabase() async {
    await StableDiffusionAppClientFlutter.saveCoreDatabase();
    return;
  }
}
